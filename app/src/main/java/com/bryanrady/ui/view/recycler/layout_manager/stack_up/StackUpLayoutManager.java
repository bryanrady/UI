package com.bryanrady.ui.view.recycler.layout_manager.stack_up;

import android.support.v4.view.ViewCompat;
import android.support.v7.widget.RecyclerView;
import android.view.View;

import com.bryanrady.ui.view.recycler.layout_manager.echelon.ItemViewInfo;
...
public class StackUpLayoutManager extends RecyclerView.LayoutManager {
    ...
    private StackUpSnapHelper mStackUpSnapHelper;

    public StackUpLayoutManager(float itemHeightWidthRatio, float scale) {
        this.mItemHeightWidthRatio = itemHeightWidthRatio;
        this.mScale = scale;
        mStackUpSnapHelper = new StackUpSnapHelper();
    }
    ...
    public void onAttachedToWindow(RecyclerView view) {
        ...
        mStackUpSnapHelper.attachToRecyclerView(view);
    }
