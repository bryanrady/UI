...
public class PathMeasureFaceLoadingView extends View {
    /**
    ...
    public PathMeasureFaceLoadingView(Context context) {
        this(context, null);
    }

    public PathMeasureFaceLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PathMeasureFaceLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    //    unreachedPath.addRoundRect(new RectF(lineWidth,lineWidth,w-lineWidth,h-lineWidth),w/6,w/6, Path.Direction.CCW);
        unreachedPath.addRoundRect(new RectF(lineWidth+50,lineWidth+50,w-lineWidth-50,h-lineWidth-50),w/6,w/6, Path.Direction.CCW);
        if(reachedPath==null){
    ...
    //    reachedPath.addRoundRect(new RectF(lineWidth,lineWidth,w-lineWidth,h-lineWidth),w/6,w/6, Path.Direction.CW);
        reachedPath.addRoundRect(new RectF(lineWidth+50,lineWidth+50,w-lineWidth-50,h-lineWidth-50),w/6,w/6, Path.Direction.CW);
    }
