 ...
 * 线性进度条---基类
 */
public abstract class LinearBaseProgressBar extends BaseProgressBar {
    //圆角
    ...
    public LinearBaseProgressBar(Context context) {
        this(context, null);
    }

    public LinearBaseProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearBaseProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LinearBaseProgressBar);
        radius = typedArray.getDimension(R.styleable.LinearBaseProgressBar_radius, -1);
        leftTopRadius = typedArray.getDimension(R.styleable.LinearBaseProgressBar_left_top_radius, 0);
        leftBottomRadius = typedArray.getDimension(R.styleable.LinearBaseProgressBar_left_bottom_radius, 0);
        rightTopRadius = typedArray.getDimension(R.styleable.LinearBaseProgressBar_right_top_radius, 0);
        rightBottomRadius = typedArray.getDimension(R.styleable.LinearBaseProgressBar_right_bottom_radius, 0);
