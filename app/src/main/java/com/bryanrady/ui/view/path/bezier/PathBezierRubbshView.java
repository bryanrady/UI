...
/**
 * https://blog.csdn.net/abnormalexit/article/details/72669960
 * Created by emotiona on 2017/5/23.
 * emotiona_xiaoshi@126.com
 */

public class PathBezierRubbshView extends View {
    ...
    public PathBezierRubbshView(Context context) {
        this(context, null);
    }

    public PathBezierRubbshView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
