    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (level == 0) {
            ...
            if (level <= icon_width) {
                canvas.save();
                // 取得灰色区域
                Gravity.apply(Gravity.LEFT, icon_width - level, icon_height, getBounds(), mRect);
                // clip灰色区域
                ...
                canvas.save();
                // 取得彩色区域
                Gravity.apply(Gravity.RIGHT, level, icon_height, getBounds(), mRect);
                // clip彩色区域
                canvas.clipRect(mRect);
                // 绘制彩色区域
            ...
            // level值>width为index_right图片
                ...
                canvas.save();
                // 取得彩色区域
                Gravity.apply(Gravity.LEFT, level - icon_width, icon_height, getBounds(), mRect);
                // clip彩色区域
                canvas.clipRect(mRect);
                // 绘制彩色区域
                mColorDrawable.draw(canvas);
                ...
                canvas.save();
                // 取得灰色区域
                Gravity.apply(Gravity.RIGHT, icon_width - (level - icon_width), icon_height, getBounds(), mRect);
                // clip灰色区域
                canvas.clipRect(mRect);
                // 绘制灰色区域
                mGrayDrawable.draw(canvas);
