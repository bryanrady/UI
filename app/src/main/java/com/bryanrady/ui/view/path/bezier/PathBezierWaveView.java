...
/**
 * http://blog.csdn.net/abnormalexit/article/details/72681009
 * Created by sxshi on 2017/5/24.
 */

public class PathBezierWaveView extends View {
    ...
    public PathBezierWaveView(Context context) {
        this(context, null);
    }

    public PathBezierWaveView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
