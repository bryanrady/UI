 ...
 */
public class PathBezierViewStep2 extends View {
    ...
    public PathBezierViewStep2(Context context) {
        this(context,null);
    }

    public PathBezierViewStep2(Context context, @Nullable AttributeSet attrs) {
    ...
    public PathBezierViewStep2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
