...
public class Dn3_CircleProgressBar2 extends View {
    private int max;
    ...
    public Dn3_CircleProgressBar2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        paint = new Paint();
