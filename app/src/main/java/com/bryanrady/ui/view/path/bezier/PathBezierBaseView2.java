...
public class PathBezierBaseView2 extends View {
    ...
    public PathBezierBaseView2(Context context) {
        this(context,null);
    }

    public PathBezierBaseView2(Context context, @Nullable AttributeSet attrs) {
    ...
    public PathBezierBaseView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
