...
public class TweenAnimationActivity extends StatusBarBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_translate_animation:
                intent.setClass(this, TweenTranslateActivity.class);
                startActivity(intent);
                break;
            case R.id.btn_scale_animation:
                intent.setClass(this, TweenScaleActivity.class);
                startActivity(intent);
                break;
            case R.id.btn_rotate_animation:
                intent.setClass(this, TweenRotateActivity.class);
                startActivity(intent);
                break;
            case R.id.btn_alpha_animation:
                intent.setClass(this, TweenAlphaActivity.class);
                startActivity(intent);
                break;
            case R.id.btn_set_animation:
                intent.setClass(this, TweenSetActivity.class);
                startActivity(intent);
                break;
        }
    }
