...
public class Dn16_SetAnimationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startXmlSetAnimation() {
        Animation setAnimation = AnimationUtils.loadAnimation(this,R.anim.dn16_tween_set);
